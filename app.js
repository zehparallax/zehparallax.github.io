...
(function () {
  ...
  function zeichneEndstand() {
    ...
    stand.forEach(function (e, i) {
      ...
      var name = machen("span", "endzeile__name");
      if (sieger) {
  ...
  function zeichneHistorie() {
    ...
    historie.forEach(function (runde, r) {
      ...
      runde.forEach(function (e) {
        var zelle = machen("td", "zahl");
        var klasse = "wert";
        if (e.punkte === maxP) klasse += " wert--hoch";
        else if (e.punkte === minP) klasse += " wert--tief";
        zelle.appendChild(
          machen("span", klasse, e.ansage + " / " + e.stiche + " / " + e.punkte)
        );
